...
#SBATCH --output=output_kin_nonkin_model/kinship_training_19nov.out
#SBATCH --error=output_kin_nonkin_model/kinship_training_19nov.err
...
python /cephyr/users/mehdiyev/Alvis/kinship_project/src/kinship_model.py
