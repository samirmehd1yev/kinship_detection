...
#SBATCH --output=output_kin_nonkin_model/kinship_training3.out
#SBATCH --error=output_kin_nonkin_model/kinship_training3.err
...
python /cephyr/users/mehdiyev/Alvis/kinship_project/src/kin_nonkin_training_v3.py
