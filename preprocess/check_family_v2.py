...
# This script analyzes the family distribution across the train, val, and test splits. 
# It prints the number of unique families in each split, the overlap between the splits, 
# and the statistics of triplets per family in each split.
