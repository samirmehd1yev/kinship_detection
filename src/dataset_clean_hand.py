...
def main():
    csv_path = '/mimer/NOBACKUP/groups/naiss2023-22-1358/samir_kinship_data/processed/fiw/train/filtered_triplets_with_labels.csv'
    bad_images_path = '../low_quality_images_hand.txt'
    output_path = '/mimer/NOBACKUP/groups/naiss2023-22-1358/samir_kinship_data/processed/fiw/train/hand_cleaned_filtered_triplets_with_labels.csv'
...
# (kinship_venv) [mehdiyev@alvis1 src]$ python dataset_clean_hand.py 
# Processing 189550 triplets...
# 100%|██████████████████████████████████████████████████████████████████████████████| 181195/181195 [03:17<00:00, 918.98it/s]

# Filtering Results:
# Initial triplets: 189,550
# Removed triplets: 8,355
# Final triplets: 181,195
# Removal percentage: 4.41%

# Filtered dataset saved to: /mimer/NOBACKUP/groups/naiss2023-22-1358/samir_kinship_data/processed/fiw/train/hand_cleaned_filtered_triplets_with_labels.csv