...
def train_model(model, train_loader, val_loader, test_loader, config):
    ...
    for epoch in range(config['epochs']):
        ...
        if val_metrics['accuracy'] > best_val_metrics['accuracy']:
            ...
            torch.save(checkpoint, 'checkpoints_v3/best_model.pth')
...
def main():
    ...
    if args.test_only:
        ...
        best_checkpoint = torch.load('checkpoints_v3/best_model.pth')
        ...
        with open('checkpoints_v3/comprehensive_test_results.json', 'w') as f:
            json.dump(comprehensive_results, f, indent=4)
        
        print("\nComprehensive results saved to: checkpoints_v3/comprehensive_test_results.json")
        return
    ...
    if args.continue_training:
        ...
        checkpoint = torch.load('checkpoints_v3/best_model.pth')
    ...
    with open('checkpoints_v3/final_results.json', 'w') as f:
