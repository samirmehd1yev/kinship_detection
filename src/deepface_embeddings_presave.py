...
def verify_saved_embeddings(embeddings_dict, output_dir):
    ...
    try:
        # Save embeddings
        embeddings_file = os.path.join(output_dir, 'facenet512_embeddings.pkl')
...
def generate_and_save_embeddings(csv_path, output_dir, sample_size=None, model="Facenet512"):
...
if __name__ == "__main__":
    ...
    output_dir = 'facenet512_embeddings'
