...
#SBATCH --output=training_output/kin_relationship_v2.log
#SBATCH --error=training_output/kin_relationship_v2.err
...
python /mimer/NOBACKUP/groups/naiss2023-22-1358/samir_code/kinship_project/src/kin_relationship_v2.py
