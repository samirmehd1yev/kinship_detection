...
#SBATCH --output=output_kin_nonkin_model2/dataset_clean_hand.out
#SBATCH --error=output_kin_nonkin_model2/dataset_clean_hand.err
...
python /cephyr/users/mehdiyev/Alvis/kinship_project/src/dataset_clean_hand.py
