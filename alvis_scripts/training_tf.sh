...
#SBATCH --output=output_kin_nonkin_model2/kinship_deepface_facenet512.out
#SBATCH --error=output_kin_nonkin_model2/kinship_deepface_facenet512.err
...
python /mimer/NOBACKUP/groups/naiss2023-22-1358/samir_code/kinship_project/src/kinship_deepface.py
