...
#SBATCH --output=training_output/kinship_ensemble_model_v2.log
#SBATCH --error=training_output/kinship_ensemble_model_v2.err
...
python /mimer/NOBACKUP/groups/naiss2023-22-1358/samir_code/kinship_project/src/kinship_ensemble_model_v2.py
